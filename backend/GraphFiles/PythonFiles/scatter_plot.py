...
def generate_scatter_plot(x_points, y_points):
...
def main():
    if len(sys.argv) < 3:
        print("Error: Please provide both X and Y points as arguments.")
        return
    ...
    plot_path = generate_scatter_plot(x_points, y_points)
    print(plot_path)
